...
void platform::set_neighbours(platform *lp_in, platform *rp_in, platform *tp_in,
                              platform *bp_in) {
...
platform *platform::get_neighbour(unsigned int side) {
  ...
  switch (side) {
  case TOP: return this->tp;
  case BOTTOM: return this->bp;
  case LEFT: return this->lp;
  case RIGHT: return this->rp;
