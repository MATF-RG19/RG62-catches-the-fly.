...
spider::spider(platform *p) { init(p); }

void spider::reset(platform *p) { init(p); }

// metod koji na osnovu informacije u kom smeru igrac gleda odredjuje vektor
// pravca
...
void spider::set_angle(double a) { this->angle = a; }

void spider::set_key(bool k) { this->key = k; }

void spider::set_dead(bool d) { this->dead = d; }
...
void spider::set_platform(platform *p) { this->current_platform = p; }

bool spider::get_key() { return key; }

bool spider::get_dead() { return this->dead; }

platform *spider::get_platform() { return current_platform; }
